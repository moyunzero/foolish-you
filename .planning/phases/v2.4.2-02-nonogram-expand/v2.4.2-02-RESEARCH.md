...
2. **ROADMAP text drift**
   - What we know: ROADMAP/REQUIREMENTS still say ≈120 / roughly balanced.
   - What's unclear: Whether v2.4.2-03 or docs pass should rewrite ROADMAP.
   - Recommendation: Planner notes CONTEXT override in PLAN.md; optional doc sync deferred to ship phase.
