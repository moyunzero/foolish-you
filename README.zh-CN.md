...
`app.json` 中已配置应用名 **傻了么**、Bundle ID `com.moyunzero.foolish-you`、深色界面。当前 **iOS 生产版 `2.1.0`** 经 EAS `production` 构建并提交 App Store Connect；留存 KPI 见 App Store Connect Analytics（应用内无第三方 analytics SDK）。
