...
**End users:** install **[傻了么 / Brainfool on the App Store](https://apps.apple.com/app/id6770218110)** (`2.1.0`, iOS). The steps below are for contributors cloning the repo.
