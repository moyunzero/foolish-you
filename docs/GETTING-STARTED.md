...
**End users:** install **[傻了么 / Brainfool on the App Store](https://apps.apple.com/app/id6770218110)** (live `2.4.0`; repo marketing `2.4.1`). The steps below are for contributors cloning the repo.
