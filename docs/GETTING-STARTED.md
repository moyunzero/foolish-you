...
**End users:** install **[傻了么 / Brainfool on the App Store](https://apps.apple.com/app/id6770218110)** (Live `2.5.0`). The steps below are for contributors cloning the repo.
